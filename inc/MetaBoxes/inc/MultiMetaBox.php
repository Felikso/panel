...
class MultiMetaBox extends MetaboxClass
{
	...
	public function ajax_multibox()
	{
		...
		// convert
/* 		add_action( 'add_meta_boxes', [$this, 'mx_convert_multibox'] );

		// decode
		add_action( 'add_meta_boxes', [$this, 'mx_decode_multibox'] ); */
	...
	public function register_scrips()
	{
		...
		public function multibox_scripts()
		{
			...
			// Vue.js development
			wp_enqueue_script( 'mx-vue-js', VW_URL_TO_ASSETS_FOLDER . '/vue-dev.js', [], '2', true );

			// Vue.js production
			// wp_enqueue_script( 'mx-vue-js', MX_METABOXEX_URL_TO_FOLDER . '/vue-production.js', [], '2', true );
	
			// Vue.js custom
			wp_enqueue_script( 'mx-vue-js-custom-init', VW_URL_TO_ASSETS_FOLDER . '/vue-custom.js', [ 'mx-vue-js', 'jquery' ], time(), true );

			// there is a data
			wp_enqueue_script( 'mx-vue-js-custom-saved', VW_URL_TO_ASSETS_FOLDER . '/vue-custom-saved.js', [ 'mx-vue-js', 'jquery', 'mx-vue-js-custom-init' ], time(), true );
			...
			// style 
			wp_enqueue_style( 'mx-multibox-style', VW_URL_TO_ASSETS_FOLDER . '/multibox.css', [], time() ); 
