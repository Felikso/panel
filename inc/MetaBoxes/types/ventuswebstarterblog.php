...
class ventuswebstarterblog extends MetaboxRegisterFields
{
...
$blog_post_img_object = [
    [
    'title' => [
        'blog-post-image' => 'podstawowe zdjęcie wpisu',
    ],
],

];

foreach($blog_post_img_object as $object) {
 ...
 $text_field_object = array(
    [
        'title' => [
            'blog-post-title' => 'tytuł postu',
        ]
    ],
    [
        'title' => [
            'blog-post-subtitle' => 'podtytuł do wpisu',
        ]
    ],
    [
        'title' => [
            'blog-post-farewell' => 'tekst pożegnalny',
        ]
    ],
    [
        'title' => [
 ...
 $blog_editor_field_object = array(
    [
        'title' => [
            'blog-post-content' => 'główna treść postu',
        ]
    ],

);

    foreach($blog_editor_field_object as $object) {
        $name = key((array)$object['title']);
...
$menu_about_main_content_object = [
    [
        'title' => [
            'blog-post-excerpt' => 'zajawka do wpisu',
        ]
    ],
...
[
 ...
 foreach($blog_post_tags_field_array as $field => $object) {
