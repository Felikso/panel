...
class CustomPostTypeController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'ventusweb_plugin_cpt_settings',
				'option_name' => 'ventusweb_plugin_cpt',
	...
	public function setFields()
	{
		...
		$args = array(
			...
			array(
				'id' => 'meta_field',
				'title' => 'Meta field',
				'callback' => array( $this->cpt_callbacks, 'metaField' ),
				'page' => 'ventusweb_cpt',
				'section' => 'ventusweb_cpt_index',
				'args' => array(
					'option_name' => 'ventusweb_plugin_cpt',
	...
	{
		$options = get_option( 'ventusweb_plugin_cpt' ) ?: array();
