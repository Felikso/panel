...
class CptCallbacks
{
	...
	{
		echo 'Create as many Custom Post Types as you wanttt.';

	}

	public function cptSanitize( $input )
	{
		$output = get_option('ventusweb_plugin_cpt');
...
public function metaField( )
{
	...
	echo '<script>';
	echo 'console.log('. json_encode( $image , JSON_HEX_TAG) .')';
	echo '</script>'; 

	echo '<script>';
	echo 'console.log('. json_encode( wp_get_attachment_metadata( 381 ) , JSON_HEX_TAG) .')';
	echo '</script>'; 
