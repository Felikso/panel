document.addEventListener('DOMContentLoaded', function (e) {
    const showAuthBtn = document.getElementById('ventusweb-show-auth-form'),
        authContainer = document.getElementById('ventusweb-auth-container'),
        close = document.getElementById('ventusweb-auth-close');
